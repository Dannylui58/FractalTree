...
{   
  ...
  double angle3 = angle+Math.random()*0.5-0.2;
  ...
  if(branchLength > smallestBranch){
    drawBranches(endX1, endY1, branchLength, angle1, col-50);
    drawBranches(endX2, endY2, branchLength, angle2, col-50);
    drawBranches(endX3, endY3, branchLength, angle3, col-50);  
  }//your code here    
} 
